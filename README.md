...
| Kind | Command | Status |
| --- | --- | --- |
| Unit tests | `pnpm test` (all workspaces via turbo) | active — suites arrive with the CI story (70% coverage gate) |
| E2E (Playwright) | — | pending the CI/e2e story (smoke specs: app shell renders, health returns 200) |
